    ...
    return (
        ...
        <div className='mt-16 pb-16'>
            ...
            {myOrders.map((order, index) => (
                ...
                <div
                    key={index}
                    className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl bg-white'
                >
                    ...
                    {order.items.map((item, index) => {
                        ...
                        return (
                            ...
                            <div
                                ...
                                border-gray-300 flex flex-col md:flex-row 
                                md:items-center justify-between p-4 py-5 md:gap-16 
                                w-full max-w-4xl`}
                            >
