...
//                 {/* Review Form */}
//                 <div className="border rounded-2xl p-6 bg-white mb-10">
...
//                         className="mt-5 bg-primary hover:bg-primary-dull text-white px-8 py-3 rounded-lg"
//                     >
//                         Submit Review
//                     </button>
...
//                         placeholder="Write your review..."
//                         rows="3"
//                         className="w-full border border-gray-300 rounded-xl p-4 outline-none resize-none focus:border-primary"
//                     />
